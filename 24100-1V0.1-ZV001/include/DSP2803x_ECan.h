...
extern myCanMsg_t canRxMsg,canTxMsg;

extern void CanErrorHandle(void);
extern void CanInfoTx(void);
extern Uint32 MsgRx(myCanMsg_t* pCanRxMsg);
extern void CanMsgHandle(void); 
